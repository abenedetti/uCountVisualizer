  ...
  column(12,
   navbarPage(
    ...
    tabPanel("Data",
     wellPanel(
      fluidRow(
       column(1, offset=1, selectInput("idYearD", "", selected=NULL, multiple=FALSE, choice=c('Year' = '', substr(seq(as.Date("2016/3/12"), Sys.Date(), "years"),1,4)))),
      ...
      tabPanel("Visualizer charts",
       tabsetPanel(
        ...
        tabPanel(em("Charts 1 & 2"),
         ...
         fluidRow(
          column(1, selectInput("idYearC1", "", selected=NULL, multiple=FALSE, choice=c('Year' = '', substr(seq(as.Date("2016/3/12"), Sys.Date(), "years"),1,4)))),
         ...
         fluidRow(
          column(1, selectInput("idYearC2", "", selected=NULL, multiple=FALSE, choice=c('Year' = '', substr(seq(as.Date("2016/3/12"), Sys.Date(), "years"),1,4)))),
      ...
      tabPanel("Katung's charts",
       tabsetPanel(
        ...
        tabPanel(em("Chart 3"),
         ...
         fluidRow(
          br(),
          column(5, h4("Chart 3: Mean per weekday grouped by week number"))
         ),
         fluidRow(
          tags$head(tags$style(HTML('#idWeekdayC3{text-align: center;}'))),
          column(4, checkboxGroupInput("idWeekdayC3", "", selected=c("Sun.","Mon.","Tue.","Wed.","Thu.","Fri.","Sat."), inline = TRUE, choice=c("Sun.","Mon.","Tue.","Wed.","Thu.","Fri.","Sat."))),
        ...
        tabPanel(em("Chart 4"),
         ...
         fluidRow(
          br(),
          column(5, h4("Chart 4: Mean variation per weekday grouped by week number"))
         ),
         fluidRow(
          tags$head(tags$style(HTML('#idWeekdayC4{text-align: center;}'))),
          column(4, checkboxGroupInput("idWeekdayC4", "", selected=c("Sun.","Mon.","Tue.","Wed.","Thu.","Fri.","Sat."), inline = TRUE, choice=c("Sun.","Mon.","Tue.","Wed.","Thu.","Fri.","Sat."))),
      ...
      tabPanel("uCount's charts",
       tabsetPanel(
        ...
        tabPanel(em("Chart 5"),
         ...
         fluidRow(
          column(1, selectInput("idYearC5", "", selected=NULL, multiple=FALSE, choice=c('Year' = '', substr(seq(as.Date("2016/3/12"), Sys.Date(), "years"),1,4)))),
        ...
        tabPanel(em("Chart 6"),
         ...
         fluidRow(
          column(1, selectInput("idYearC6", "", selected=NULL, multiple=FALSE, choice=c('Year' = '', substr(seq(as.Date("2016/3/12"), Sys.Date(), "years"),1,4)))),
